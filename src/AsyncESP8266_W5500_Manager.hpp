/****************************************************************************************************************************
  AsyncESP8266_W5500_Manager.hpp
...
#ifndef AsyncESP8266_W5500_Manager_hpp
#define AsyncESP8266_W5500_Manager_hpp
...
#define ASYNC_ESP8266_W5500_MANAGER_VERSION           "AsyncESP8266_W5500_Manager v1.0.0"

#define ASYNC_ESP8266_W5500_MANAGER_VERSION_MAJOR     1
#define ASYNC_ESP8266_W5500_MANAGER_VERSION_MINOR     0
#define ASYNC_ESP8266_W5500_MANAGER_VERSION_PATCH     0

#define ASYNC_ESP8266_W5500_MANAGER_VERSION_INT       1000000
...
#include "AsyncESP8266_W5500_Manager_Debug.h"
...
class ESPAsync_EMParameter 
{
  ...
  private:
    ...
    friend class AsyncESP8266_W5500_Manager;
};
...
class AsyncESP8266_W5500_Manager
{
  public:

    AsyncESP8266_W5500_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver, const char *iHostname = "");
...
#endif    // AsyncESP8266_W5500_Manager_hpp
